...
if (isset($_SESSION['username'])) {
    $sql = "SELECT * FROM expenses WHERE is_archived = 1";
    ...
    if(isset($_POST['val'])) {
        ...
        $sql = "SELECT * FROM expenses WHERE $field = '$val' AND is_archived = 1";
        $result = mysqli_query($conn, $sql);
    }
...
<body>
    <div class="main_container">
        ...
        <div class="content_container">
            ...
            <h1 class="table_label">Expenses Table</h1>
            <br><a class="archive_button_active" href="expenses.php">Archive</a><br>
            </div>
    
            <div class="search_bar">
                <form method="Post" action="expenses.php">Category:
            ...
            <table class="data_table">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr class="data_tr">
                            ...
                            <td>
                                <a href="editExpense_confirm.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_edit.png" alt="Edit" width="20" height="20"></a>
                                <a href="deleteExpense.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_delete.png" alt="Delete" width="20" height="20"></a>
                            </td>
                        </tr>
                <?php } ?>
            </table>
