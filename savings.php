...
if (isset($_SESSION['username'])) {
    $sql = "SELECT * FROM savings WHERE is_archived is NULL";
    ...
    if(isset($_POST['val'])) {
        ...
        $sql = "SELECT * FROM savings WHERE $field = '$val' AND is_archived is NULL";
        $result = mysqli_query($conn, $sql);
    }
...
<body>
    <div class="main_container">
        ...
        <div class="content_container">
            ...
            <h1 class="table_label">Savings Table</h1>
            <br><a class="archive_button" href="savings_archive.php">Archive</a><br>
            </div>
        
            <div class="search_bar">
                <form method="Post" action="debts.php">Category:
                <select class="input_box" name="field">
                    <option value="debt_id">Savings Amount</option>
            ...
            <table class="data_table">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr class="data_tr">
                            ...
                            <td>
                                <a href="editSaving_confirm.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_edit.png" alt="Edit" width="20" height="20"></a>
                                <a href="deleteSaving.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_delete.png" alt="Delete" width="20" height="20"></a>
                            </td>
                        </tr>
                <?php } ?>
            </table>
