...
if (isset($_SESSION['username'])) {
    $sql = "SELECT * FROM saving_goals WHERE is_archived = 1";
    ...
    if(isset($_POST['val'])) {
        ...
        $sql = "SELECT * FROM saving_goals WHERE $field = '$val' AND is_archived = 1";
        $result = mysqli_query($conn, $sql);
    }
...
<body>
    <div class="main_container">
        ...
        <div class="content_container">
            ...
            <br><a class="archive_button_active" href="savingGoals.php">Archive</a><br>
            </div>
