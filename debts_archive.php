...
if (isset($_SESSION['username'])) {
    $sql = "SELECT * FROM debts WHERE is_archived = 1";
    ...
    if(isset($_POST['val'])) {
        ...
        $sql = "SELECT * FROM debts WHERE $field = '$val' AND is_archived = 1";
        $result = mysqli_query($conn, $sql);
    }
...
<body>
    <div class="main_container">
        ...
        <div class="content_container">
            ...
            <h1 class="table_label">Debts Table</h1>
            <br><a class="archive_button_active" href="debts.php">Archive</a><br>
            </div>
            ...
            <div class="search_bar">
                ...
                <select class ="input_box" name="field">
                    ...
                    <option value="paid_amount">Amount Paid</option>
                    <option value="total_debt">Total Debt</option>
                    <option value="date">Date Debt Created</option>
                </select>
            ...
            <table class="data_table">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr class="data_tr">
                            ...
                            <td>
                                <a href="editDebt_confirm.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_edit.png" alt="Edit" width="20" height="20"></a>
                                <a href="deleteDebt.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_delete.png" alt="Delete" width="20" height="20"></a>
                            </td>
                        </tr>
                <?php } ?>
            </table>
