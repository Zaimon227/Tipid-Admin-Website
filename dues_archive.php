...
if (isset($_SESSION['username'])) {
    $sql = "SELECT * FROM dues WHERE is_archived = 1";
    ...
    if(isset($_POST['val'])) {
        ...
        $sql = "SELECT * FROM dues WHERE $field = '$val' AND is_archived = 1";
        $result = mysqli_query($conn, $sql);
    }
...
<body>
    <div class="main_container">
        ...
        <div class="content_container">
            ...
            <br><a class="archive_button_active" href="dues.php">Archive</a><br>
            </div>
