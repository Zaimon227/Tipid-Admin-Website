...
if (isset($_SESSION['username'])) {
    $sql = "SELECT * FROM debt_payments WHERE is_archived is NULL";
    ...
    if(isset($_POST['val'])) {
        ...
        $sql = "SELECT * FROM debt_payments WHERE $field = '$val' AND is_archived is NULL";
        $result = mysqli_query($conn, $sql);
    }
...
<html>
<head>
    <title>Debt Payments Page</title>
...
<body>
    <div class="main_container">
        ...
        <div class="content_container">
            ...
            <h1 class="table_label">Debt Payments Table</h1>
            <br><a class="archive_button" href="debtPayment_archive.php">Archive</a><br>
            </div>
    
            <div class="search_bar">
                <form method="Post" action="debts.php">Category:
                <select class ="input_box" name="field">
                    <option value="debt_id">Debt ID</option>
                    <option value="amount">Amount Paid</option>
                    <option value="date">Date Paid</option>
                </select>
            ...
            <table class="data_table">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr class="data_tr">
                            ...
                            <td><?php echo $row['debt_id'];?></td>
                            <td><?php echo $row['amount'];?></td>
                            <td><?php echo $row['date'];?></td>
                            <td>
                                <a href="editDebtPayment_confirm.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_edit.png" alt="Edit" width="20" height="20"></a>
                                <a href="deleteDebtPayment.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_delete.png" alt="Delete" width="20" height="20"></a>
                            </td>
                        </tr>
                <?php } ?>
            </table>
