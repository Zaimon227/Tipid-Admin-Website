...
if (isset($_SESSION['username'])) {
    $sql = "SELECT * FROM saving_goals WHERE is_archived is NULL";
    ...
    if(isset($_POST['val'])) {
        ...
        $sql = "SELECT * FROM saving_goals WHERE $field = '$val' AND is_archived is NULL";
        $result = mysqli_query($conn, $sql);
    }
...
<body>
    <div class="main_container">
        ...
        <div class="content_container">
            ...
            <h1 class="table_label">Saving Goals Table</h1>
            <br><a class="archive_button" href="savingGoals_archive.php">Archive</a><br>
            </div>
            ...
            <table class="data_table">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr class="data_tr">
                            ...
                            <td>
                                <a href="editSavingGoal_confirm.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_edit.png" alt="Edit" width="20" height="20"></a>
                                <a href="deleteSavingGoal.php?id=<?php echo $row['id'];?>"><img src="graphics/icon_delete.png" alt="Delete" width="20" height="20"></a>
                            </td>
                        </tr>
                <?php } ?>
            </table>
